...
//#define __EXAMPLE_HTTP_GET__
#ifdef __EXAMPLE_HTTP_GET__
...
#if (HTTP_REQUEST == 0)
// url for http-get
#define HTTP_URL_ADDR   "http://14.226.231.140:8888/\0"   //  http://www.quectel.com/\0
#elif (HTTP_REQUEST == 1)
// url for http-post
#define HTTP_URL_ADDR   "http://14.226.231.140:8888/data_collect/testpost/\0"	//"http://www.quectel.com/\0"
#elif (HTTP_REQUEST == 2)
// url for http-file
...
#define HTTP_POST_MSG   "packetid=20&devid=100&devname=a&parameter=ssa&owner=1&curr_Temp=20.1&curr_Humid=34.1&curr_Lat=12.01&curr_Long=78.01&timestamp=2018-04-21 13:45:36&note=hoangphuong\0"	//"Message=HelloQuectel\0"
            ...
            case MSG_ID_URC_INDICATION:
                ...
                case URC_GPRS_NW_STATE_IND:
                    ...
                    if (NW_STAT_REGISTERED == msg.param2 || NW_STAT_REGISTERED_ROAMING == msg.param2)
                    {
                        ...
                        {// HTTP-get
                            HTTP_Program(0);
                            // cần in mã html ra dùng UART output
                        }
