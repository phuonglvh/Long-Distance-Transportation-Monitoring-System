...
void proc_main_task(s32 taskId)
{
    ...
    Ql_Timer_RegisterFast(GP_timer, Timer_handler, &m_param2);
    Ql_Timer_Start(Stack_timer,ST_Interval,TRUE);
    Ql_Timer_Start(GP_timer,GPT_Interval,FALSE);
...
static void Location_Program(void)
{
   ...
   APP_DEBUG("<--Ql_Getlocation1-->\r\n");
   RIL_GetLocation(Callback_Location);
   APP_DEBUG("<--Ql_Getlocation2-->\r\n");
}
