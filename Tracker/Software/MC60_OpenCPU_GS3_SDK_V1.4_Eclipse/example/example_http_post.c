 ...
 *      Author: nhan
 */
//#define __EXAMPLE_HTTP_POST__
#ifdef __EXAMPLE_HTTP_POST__
...
****************************************************************************/
#define APN_NAME        "CMNET\0" // CMNET\0
#define APN_USERID      ""
#define APN_PASSWD      ""

#define HTTP_REQUEST  1  // 0=http-get, 1=http-post, 2=http-file
#define HTTP_URL_ADDR   "http://14.226.231.140:8888/data_collect/testpost/\0"
#define HTTP_POST_MSG   "packetid=20&devid=100&devname=a&parameter=ssa&owner=1&curr_Temp=20.1&curr_Humid=34.1&curr_Lat=12.01&curr_Long=78.01&timestamp=2018-04-21 13:45:36&note=hoangphuong\0"
...
void proc_main_task(s32 taskId)
{
    ...
    APP_DEBUG("\r\nOpenCPU: example for HTTP POST programming\r\n");
...
static void HTTP_Program(u8 http_action)
{
    ...
    // Set PDP context
    Ql_sprintf(strAT,"AT+QIFGCNT=0");
    APP_DEBUG("<-- Set GPRS PDP context -->\r\n");

    // Set APN
    Ql_sprintf(strAT,"AT+QICSGP=1,\"CMNET\"");
    APP_DEBUG("<-- Set GPRS APN -->\r\n");

    // Open/Activate PDP context
    Ql_sprintf(strAT,"AT+QIREGAPP");
    Ql_sprintf(strAT,"AT+QIACT");
    APP_DEBUG("<-- Open PDP context -->\r\n");
